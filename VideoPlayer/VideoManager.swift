...
//  VideoPlayer
//
//  Created by Nawaf Alotaibi on 05/07/2022.
//
...
class VideoManager:ObservableObject{
    ...
    func findVideos(topic:Query) async{
        do{
            ...
            urlRequest.setValue("My api key", forHTTPHeaderField: "Authorization")
        ...
        }catch{print("Error fetching data from Pexels: \(error)")}
    }
}
